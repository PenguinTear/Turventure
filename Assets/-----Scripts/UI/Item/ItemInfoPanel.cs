...
namespace LittleTurtle.UI {
    ...
    public class ItemInfoPanel : MonoBehaviour{
        ...
        public GameObject Use_Btn, Feed_Btn, Unequip_Btn;
        ...
        public System.Action action_OpenItemInfoPanel;
        public void ShowItemInfo(Slot slot) {
            ...
            // for guidance
            action_OpenItemInfoPanel?.Invoke();
        }
        ...
        public void _Feed() {
            if (slot.Quantity > 1) {
                TurtleCtrl.Instance.Feed(slot);
            }
            else {
                TurtleCtrl.Instance.FeedConfirm(slot, 1);
            }
        }
    }
}
